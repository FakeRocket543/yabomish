...
EXCLUDE="CINImportCoordinator|PrefsWindow|CandidatePanel|DomainCardView|DomainCollectionController|DomainOrderManager|ModeToast|AppDelegate|DataDownloader|YabomishInputController|DebugLog"
