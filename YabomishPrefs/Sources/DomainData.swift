...
enum DomainData {
    static let generalDomains: [DomainEntry] = [
        ...
        .init(id: "domain_cn_slang", file: "terms_cn_slang", label: "中式流行語", icon: "bubble.left", desc: "中式網路用語", group: .general),
    ...
    static let proDomains: [DomainEntry] = [
        ...
        .init(id: "domain_media", file: "terms_media", label: "新聞傳播", icon: "newspaper", desc: "新聞媒體出版", group: .professional, category: .humanities),
        .init(id: "domain_social", file: "terms_social", label: "社會行政", icon: "person.3", desc: "社工行政福利", group: .professional, category: .humanities),
        .init(id: "domain_govt", file: "terms_govt", label: "政府機關", icon: "building.2", desc: "機關職稱公文", group: .professional, category: .humanities),
        .init(id: "domain_art", file: "terms_art", label: "藝術", icon: "paintpalette", desc: "視覺音樂舞蹈", group: .professional, category: .humanities),
        // 資訊工程
        .init(id: "domain_it", file: "terms_it", label: "資訊科技", icon: "desktopcomputer", desc: "軟體硬體網路", group: .professional, category: .infoEng),
        .init(id: "domain_ee", file: "terms_ee", label: "電機電子", icon: "bolt", desc: "電機電子通訊", group: .professional, category: .infoEng),
        .init(id: "domain_power", file: "terms_power", label: "電力", icon: "bolt.batteryblock", desc: "電力電工能源", group: .professional, category: .infoEng),
        .init(id: "domain_eng", file: "terms_eng", label: "工程", icon: "wrench.and.screwdriver", desc: "土木水利工業", group: .professional, category: .infoEng),
        ...
        .init(id: "domain_phy", file: "terms_phy", label: "物理∕計量", icon: "atom", desc: "力學光學計量", group: .professional, category: .science),
        .init(id: "domain_chem", file: "terms_chem", label: "化學", icon: "flask", desc: "有機無機化工", group: .professional, category: .science),
        .init(id: "domain_bio", file: "terms_bio", label: "生物", icon: "leaf.arrow.circlepath", desc: "動物生態學", group: .professional, category: .science),
        ...
        .init(id: "domain_material", file: "terms_material", label: "材料∕礦物", icon: "cube", desc: "材料礦物冶金", group: .professional, category: .science),
        .init(id: "domain_agri", file: "terms_agri", label: "農林畜牧", icon: "tree", desc: "農林畜牧漁業", group: .professional, category: .science),
        // 地理軍事
